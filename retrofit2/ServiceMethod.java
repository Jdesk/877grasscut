...
final class ServiceMethod<T> {
    ...
    static final class Builder<T> {
        ...
        Converter<ac, T> responseConverter;
        Type responseType;
        ...
        public ServiceMethod build() {
            ...
            if (this.responseType == Response.class || this.responseType == ab.class) {
        ...
        private C1102r parseHeaders(String[] strArr) {
            ...
            for (String str : strArr) {
                ...
                if ("Content-Type".equalsIgnoreCase(substring)) {
                    ...
                    c1101a.m4560a(substring, str2);
                }
            }
            return c1101a.m4561a();
        }
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                if (this.gotUrl) {
                    ...
                    this.gotUrl = true;
                    if (type == C1106s.class || type == String.class || type == URI.class || ((type instanceof Class) && "android.net.Uri".equals(((Class) type).getName()))) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value.isEmpty()) {
                        C1102r a = C1102r.m4565a("Content-Disposition", "form-data; name=\"" + value + "\"", "Content-Transfer-Encoding", part.encoding());
                        if (Iterable.class.isAssignableFrom(r1)) {
                            if (type instanceof ParameterizedType) {
                                r0 = Utils.getParameterUpperBound(0, (ParameterizedType) type);
                                if (!C1109b.class.isAssignableFrom(Utils.getRawType(r0))) {
                        ...
                        if (!(type instanceof ParameterizedType)) {
                            throw parameterError(i, r1.getSimpleName() + " must include generic type (e.g., " + r1.getSimpleName() + "<String>)", new Object[0]);
                        } else if (C1109b.class.isAssignableFrom(Utils.getRawType(Utils.getParameterUpperBound(0, (ParameterizedType) type)))) {
                        ...
                        if (C1109b.class.isAssignableFrom(r1.getComponentType())) {
        ...
        private Converter<ac, T> createResponseConverter() {
            try {
    ...
    C1120z toRequest(Object... objArr) {
        int length;
        int i = 0;
    ...
    T toResponse(ac acVar) {
        return this.responseConverter.convert(acVar);
    }
